        ...
        <div>
            <div className="register-page">
                <div className="container">        
                    ...
                    <span id="info1">Use one of the following options to register</span><br/>
                ...
                <p id="info2">Please provide your date of birth so we know you are old enough to have an account.</p>
                ...
                <p id="info3">By clicking Sign Up, you are agreeing to <span id="terms-of-service-text">Terms of Service</span> and are acknowledging our <span id="privacy-policy-text">Privacy Policy</span> applies.</p>
