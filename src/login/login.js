    ...
    return(
        <div>
            <div className="login-page">
                ...
                <p id="text1">Please login to your account to continue</p>
                ...
                <p id="text2">By clicking Sign Up, you are agreeing to <span id="terms-of-service-text">Terms of Service</span> and are acknowledging our <span id="privacy-policy-text">Privacy Policy</span> applies.</p>
